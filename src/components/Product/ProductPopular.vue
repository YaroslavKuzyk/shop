...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {title: 'spares', price: '9 800', type: 'sale', href: '1', filters: 'spares'},
        {title: 'spares', price: '9 800', type: 'sale', href: '#', filters: 'spares'},
        {title: 'tires', price: '9 800', type: 'sale', href: '#', filters: 'tires'},
        {title: 'motors', price: '9 800', type: 'sale', href: '#', filters: 'motors'},
        {title: 'tools', price: '9 800', type: 'sale', href: '#', filters: 'tools'},
        {title: 'tires', price: '9 800', type: 'sale', href: '#', filters: 'tires'},
        {title: 'accessories', price: '9 800', type: 'sale', href: '#', filters: 'accessories'},
        {title: 'accessories', price: '9 800', type: 'sale', href: '#', filters: 'accessories'},
        {title: 'tools', price: '9 800', type: 'sale', href: '#', filters: 'tools'},
        {title: 'electronics', price: '9 800', type: 'sale', href: '#', filters: 'electronics'},
        {title: 'electronics', price: '9 800', type: 'sale', href: '#', filters: 'electronics'},
        {title: 'spares', price: '9 800', type: 'sale', href: '1', filters: 'spares'},
        {title: 'spares', price: '9 800', type: 'sale', href: '#', filters: 'spares'},
        {title: 'tools', price: '9 800', type: 'sale', href: '#', filters: 'tools'},
