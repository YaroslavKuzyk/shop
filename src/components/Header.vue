        ...
        div(v-else).header-right__account
          ...
          v-menu(offset-y left)
            ...
            v-list
              v-list-item
                v-list-item-title
                  router-link(to="test").header-link Account
              v-list-item
                v-list-item-title
                  button Log-out
        .header-right__basket
          .header-right__basket-icon
          ...
          .header-right__basket-count 1
      .mobile
        div(@click="openMainHeader").burger-menu
          span
          span
          span
</template>
...
export default {
  ...
  data() {
    return {
      ...
      headerLinks: [
        {title: "Магазины", link: 'test'},
        {title: "Акции", link: 'test'},
        {title: "Доставка и оплата", link: 'test'}
      ]
    }
  },
  methods: {
...
<style scoped lang="scss">
  ...
  .header-right__sign-in {
    margin-right: 37px;
    text-decoration: none;
    color: #000;
  }

  .header-right__sign-up {
    padding: 12px 32px;
    text-decoration: none;
    color: #000;
  ...
  .header-right__account-favorite {
    display: flex;
    align-items: center;
    margin-right: 37px;
  }
